-- Volcando estructura para tabla corona.pais
...
-- Volcando datos para la tabla corona.pais: ~240 rows (aproximadamente)
REPLACE INTO `pais` (`id`, `pais`) VALUES
	(1, 'Afganistán'),
	(2, 'Islas Gland'),
	(3, 'Albania'),
	(4, 'Alemania'),
...
-- Volcando estructura para tabla corona.personas
CREATE TABLE IF NOT EXISTS `personas` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_personas_pais` (`fk_pais`),
  CONSTRAINT `FK_personas_pais` FOREIGN KEY (`fk_pais`) REFERENCES `pais` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=90 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

-- Volcando datos para la tabla corona.personas: ~1 rows (aproximadamente)
REPLACE INTO `personas` (`id`, `nombre`, `pais`, `fk_pais`, `edad`) VALUES
	(1, 'Maira Paria', '', 201, 16);

-- Volcando estructura para tabla corona.tarea
...
-- Volcando datos para la tabla corona.tarea: 0 rows
REPLACE INTO `tarea` (`id`, `detalle`, `tarea`) VALUES
	(1, 'Es el que corta el pasto, corta la libustrina y demas', 'jardinero'),
	(2, 'Persona encargada de pasar la noche despierto controlando los ingresos de personal', 'sereno'),
	(3, 'Quizas aquí quedaria bien una foranea para saber que tipo de administracion es', 'administracion');

-- Volcando estructura para tabla corona.usuarios
...
-- Volcando datos para la tabla corona.usuarios: ~2 rows (aproximadamente)
